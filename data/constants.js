...
const teachers = [
    ...
    { id: 8, name: "Fadilah Muzhar, S.Pd.", nupy: "2287", subjects: ["Bahasa Arab","Bahasa dan Sastra Arab","Ta'bir","Jam Kedatangan"] },
    { id: 9, name: "Sri Rosita, Lc.", nupy: "2086", subjects: ["Bahasa Arab", "Haf-Hadits","Ta'bir","Jam Kedatangan"] },
    { id: 10, name: "Ummu Salmiyah Yusuf, Lc.", nupy: "2467", subjects: ["Ushul Fiqh","Faroidh","Jam Kedatangan"] },
    { id: 11, name: "Siti Miftahul Jannah, Lc., M.Pd.", nupy: "2486", subjects: ["Fiqh", "Balaghoh","Jam Kedatangan"] },
    ...
    { id: 15, name: "Risnatul Aini, Lc.", nupy: "2000", subjects: ["Shorof","Bahasa Arab","Jam Kedatangan"] },
    { id: 16, name: "Annisa Rabbani, Lc.", nupy: "2012", subjects: ["Ta'bir","Bahasa Arab","Jam Kedatangan"] },
